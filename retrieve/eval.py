...
# QARAG NOTE:
# This evaluator is still retrieval-only. It is useful because it separates
# evidence retrieval quality from final LLM answer quality.
#
# QARAG TODO:
# Add metrics for the planned compact evidence retriever:
#   - soft_evidence_recall@K when labels become soft;
#   - selected_size under adaptive threshold;
#   - connected_component_count of the selected evidence graph;
#   - path_coverage for topic-to-answer shortest/near-shortest paths;
#   - answer_recall@budget for fixed evidence budgets.
