...
# QARAG NOTE:
# This stage should stay reasoner-only. Do not train the retriever here.
# The expected contract is:
#   retrieve/inference.py -> retrieval_result.pth with scored/selected evidence
#   preprocess/prepare_data.py -> merge retrieval evidence into QA samples
#   preprocess/prepare_prompts.py -> serialize evidence for the LLM
#   main.py -> run LLM and evaluate answer quality
#
# QARAG TODO:
# Once `retrieve/inference.py` emits compact subgraph fields, add a prompt mode
# that reads those fields without changing the LLM invocation code below.
